    ...
    */
    ...
    describe('The menu', function() {
        ...
        it('menu is hidden', function() {
            let menuHiddenElement = $('.menu-hidden');
            expect(menuHiddenElement.length).toBe(1);
        });
         ...
         it('menu is shown when clicked', function() {
            ...
            // check the menu-hidden class does not appear in the page
            let menuHiddenElement = $('.menu-hidden');
            expect(menuHiddenElement.length).toBe(0);

            // now hide it by clicking it again
            $(menuElement).click();

            // check the menu-hidden class is now in the page
            menuHiddenElement = $('.menu-hidden');
            expect(menuHiddenElement.length).toBe(1);
        });
    });
